...
def main():
    ...
    dm = Kanji_TRecFITDM(root_dir='/tungstenfs/scratch/gmicro/buchtimo/gitrepos/FourierImageTransformer/examples/datamodules/data/', batch_size=int(config['DEFAULT']['batch_size']), num_angles=int(config['DEFAULT']['num_angles']))
